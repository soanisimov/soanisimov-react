            ...
            <div className="flex flex-col md:flex-row gap-5 text-white">
                {courses.map((lang) => (
                    <motion.div className="w-full flex" initial="hidden" whileInView="visible" viewport={{once: true}} variants={languageVariants}>
                        ...
                        <div className="bg-gradient-to-t from-blue-600 to-purple-800 p-6 w-full text-center rounded-3xl flex flex-col items-center">
                            ...
                            <p><a href={lang.certificate_link} target="_blank" className="">{lang.certificate_text}</a></p>
                        </div>
